        ...
        if (drawer.isDrawerOpen(GravityCompat.START))
            ...
            alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent signout = new Intent(Exchange.this,LoginActivity.class);
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch(getArguments().getInt(ARG_SECTION_NUMBER)){
                case 1:
                    ...
                    break;
                case 2:
                    //load old Materials Bought
                    rootView = inflater.inflate(R.layout.fragment_old_buy_form, container, false);
                    break;
                case 3:
                    //load old material sold
                    rootView = inflater.inflate(R.layout.fragment_old_sell_form, container, false);
                    break;
                case 4:
                    //load transaction
