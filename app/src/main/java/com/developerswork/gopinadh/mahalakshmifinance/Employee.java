...
public class Employee extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.employee);
        ...
        if (drawer.isDrawerOpen(GravityCompat.START))
            ...
            alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent signout = new Intent(Employee.this,LoginActivity.class);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch(getArguments().getInt(ARG_SECTION_NUMBER)){
                ...
                case 2:
                    //load expenses
                    rootView = inflater.inflate(R.layout.fragment_expenses_details, container, false);
                    break;
                case 3:
                    //load employee salary
                    rootView = inflater.inflate(R.layout.fragment_employee_salaries , container, false);
                    break;
            }
            return rootView;
        }
